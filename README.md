...
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=28&duration=3000&pause=800&color=02A4F0&center=true&vCenter=true&width=650&lines=Hi+there%2C+I%27m+Karthik;Senior+Software+Engineer;Flutter+%26+Mobile+Developer;Indie+App+Builder;Going+native+with+Swift+%26+SwiftUI" alt="Typing header" />
...
```yaml
name: Karthik Naga Vamsi Yadlapalli
role: Senior Software Engineer (Flutter & Mobile)
location: Hyderabad, India
experience: ~3.5 years shipping production mobile apps
currently: building consumer apps + learning Swift / SwiftUI
focus: clean architecture, thoughtful UX, product branding
open_to: Flutter / Mobile roles — Hyderabad · Bangalore · Chennai
```
...
#### 🍎 iOS / SwiftUI
Currently mapping my Flutter foundation onto native iOS — `@Observable`, SwiftData, and a feature-based MVVM structure.
...
<div align="center">
  <i>Always happy to talk Flutter, mobile architecture, or indie app ideas. ⚡</i>
</div>
